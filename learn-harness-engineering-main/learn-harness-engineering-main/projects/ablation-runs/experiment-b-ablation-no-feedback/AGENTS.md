...
4. **Inspect the existing project structure and current feature state before proceeding.**
...
1. The feature appears in `feature_list.json` with status `"pass"` and evidence.
2. The code respects Electron layer boundaries defined above.
