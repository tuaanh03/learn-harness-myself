...
import { LatestAnswerCitationCount } from './components/LatestAnswerCitationCount';
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <main style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          <div style={{ flex: 1, overflow: 'auto', padding: '20px' }}>
            ...
            <LatestAnswerCitationCount history={history} />
            <LatestAnswerConfidence history={history} />

            {history.slice().reverse().map(({ question, response }) => (
              <section key={response.timestamp} style={{
                ...
                <div style={{ fontSize: '12px', color: '#8888bb', marginBottom: '8px' }}>
                  Q: {question} | Confidence: {Math.round(response.confidence * 100)}%
                </div>
